...
const page = new (function() {
  this.title = 'ConnectionDefinition列表'
  this.icon = ''
  this.name = 'elsa_connectiondefinition'
  this.path = '/elsa/connectiondefinition'
...
export const route = {
  page,
  component: () => import(/* webpackChunkName: "Elsa.ConnectionDefinition" */ './index')
}

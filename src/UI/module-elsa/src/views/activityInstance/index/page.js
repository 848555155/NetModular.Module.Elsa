...
const page = new (function() {
  this.title = 'ActivityInstance列表'
  this.icon = ''
  this.name = 'elsa_activityinstance'
  this.path = '/elsa/activityinstance'
...
export const route = {
  page,
  component: () => import(/* webpackChunkName: "Elsa.ActivityInstance" */ './index')
}

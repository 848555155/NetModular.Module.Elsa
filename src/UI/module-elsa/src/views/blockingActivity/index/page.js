...
const page = new (function() {
  this.title = 'BlockingActivity列表'
  this.icon = ''
  this.name = 'elsa_blockingactivity'
  this.path = '/elsa/blockingactivity'
...
export const route = {
  page,
  component: () => import(/* webpackChunkName: "Elsa.BlockingActivity" */ './index')
}

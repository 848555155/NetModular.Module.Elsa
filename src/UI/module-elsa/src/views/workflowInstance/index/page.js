...
const page = new (function() {
  this.title = 'WorkflowInstance列表'
  this.icon = ''
  this.name = 'elsa_workflowinstance'
  this.path = '/elsa/workflowinstance'
...
export const route = {
  page,
  component: () => import(/* webpackChunkName: "Elsa.WorkflowInstance" */ './index')
}

...
const page = new (function() {
  this.title = 'ActivityDefinition列表'
  this.icon = ''
  this.name = 'elsa_activitydefinition'
  this.path = '/elsa/activitydefinition'
...
export const route = {
  page,
  component: () => import(/* webpackChunkName: "Elsa.ActivityDefinition" */ './index')
}
